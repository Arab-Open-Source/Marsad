...
#
#     PHX_SERVER=true bin/marsad start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :marsad, MarsadWeb.Endpoint, server: true
end
  ...
  config :marsad, MarsadWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/marsad_web/router\.ex$"E,
        ~r"lib/marsad_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/marsad/marsad.db
      """

  config :marsad, Marsad.Repo,
